    ...
    return (
      <div className="surface-panel rounded-[1.5rem] p-8 text-center">
        ...
        <p className="mt-3 text-sm leading-6 text-muted-foreground">
          Tạo database đầu tiên để cấp MySQL account riêng, scoped privileges và
          connection string cho user.
        </p>
      </div>
    );
  }
              ...
              return (
                <tr key={database.id} className="align-top">
                  <td className="px-5 py-4">
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">{database.mysqlUsername}</p>
                  </td>
